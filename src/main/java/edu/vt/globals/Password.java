 ...
 * Documentation by Team 10 on 2021-08-12
 ******************************************************************************
 */
...
public class Password {
    ...
    public static String createHash(char[] password) throws CannotPerformOperationException {
        ...
        /*
         The salted hashed password string stored and retrieved from the database
         consists of the following HASH_SECTIONS = 5 parts (parameters or sections):
                    0                1              2        3      4
            "algorithmName":"PBKDF2_ITERATIONS":"hashSize":"salt":"hash"
         */
        String parts = "sha1:"
    ...
    /*
     ...
     The caret (^) operator in Java performs a bitwise exclusive OR operation on its operands.
     */
